...
class TarjetaTest extends TestCase {
  ...
  public function testPagarViaje() {
	...
	$colectivo144Negro = new Colectivo("144 Negro", "Rosario Bus");
	$tarjeta1->pagar($colectivo144Negro, "2016/06/30 22:50");
	$this->assertEquals($tarjeta1->boleto->informacion(), "La informacion del boleto es la siguiente: <br /> " . "" . "<br />Linea o patente: ". "144 Negro" . "<br />Fecha del boleto: " ."2016/06/30 22:50" . "<br /> Tipo de boleto: " . "tarjeta" . "<br /> Saldo restante: " . 320-8 . "<br /> Numero de tarjeta: " . 1 
